...
export class Slide {
  ...
  changeSlideOnEnd() {
    ...
    if (this.dist.movement > 120 && this.index.next !== undefined) {
      ...
      // Reverte para o slide ativo se o movimento não foi suficiente para mudar para o próximo ou anterior
  ...
  onResize() {
    // Quando a janela é redimensionada, recalcula as configurações dos slides após um curto atraso
    setTimeout(() => {
      this.slidesConfig();
      this.changeSlide(this.index.active);
    }, 1000);
